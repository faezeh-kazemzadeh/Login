    ...
    product && (
      <div className={styles.productCard}>
        ...
        <div className={styles.productContent}>
         ...
         <h1 className={styles.productName}>
          ...
          <p>{product.description}</p>
            ...
            {product.discount > 0 ? <p className={styles.productDiscountedPrice}><span>Discounted Price : </span>{discountPrice} </p> :''}
        ...
        <div className={styles.actions}>
            ...
            <button type="button"><IoTrashOutline/></button>
            <button type="button">+</button>
            <button type="button">-</button>
          </div>
          <button type="button" onClick={()=> navigate(-1)} className="flex items-center"><IoIosArrowBack /> Back</button>
        </div>
        </div>
      </div>
    )
